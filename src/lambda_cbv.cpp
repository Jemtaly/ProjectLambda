...
struct OprType { char first; opr_t second; };
struct CmpType { char first; cmp_t second; };
struct OprPair { OprType first; BigInt second; };
struct CmpPair { CmpType first; BigInt second; };
struct Function { std::string first; Tree second; };
struct Application { Tree first; Tree second; };
struct Argument { Tree first; bool second; };
